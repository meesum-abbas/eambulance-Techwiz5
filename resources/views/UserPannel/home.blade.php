        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('userpannel/img/ambulance-bg2.jpg') }}" class="img-fluid w-100"
                        alt="First slide" />
                    <div class="carousel-caption">
                        <div class="container py-4">
                            <div class="row g-5">
    ...
    <div class="container-fluid feature py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                <h1 class="display-5 text-capitalize mb-3">Ambulance <span class="text-primary">Features</span></h1>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{ asset('userpannel/img/ambulance-icon-26.png') }}" class="img-fluid w-100"
