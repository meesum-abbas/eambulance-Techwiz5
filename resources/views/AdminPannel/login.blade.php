...
<head>
    ...
    <title>Rapid Rescue - Login Page</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="{{ asset('adminpannel/images/ambulance-icon-26.png') }}" height="150"
                                        alt="">
                                    <h4>Rapid <span class="text-danger">Rescue</span></h4>
                                </a>
                                ...
                                <form>
                                    ...
                                    <a href="./index.html" class="btn btn-outline-danger w-100 py-8 fs-4 mb-4">Sign In</a>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">New to Rapid Rescue</p>
